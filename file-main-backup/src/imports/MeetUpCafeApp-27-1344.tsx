import svgPaths from "./svg-nx4zwnwy64";
...
function Container26() {
  return (
    <div className="absolute bg-indigo-100 content-stretch flex items-center justify-center left-[95.9px] rounded-[2.68435e+07px] size-[64px] top-0" data-name="Container">
      <p className="font-['Arial:Regular',_'Noto_Sans_Symbols:Regular',_sans-serif] leading-[32px] relative shrink-0 text-[24px] text-center text-neutral-950 text-nowrap whitespace-pre" style={{ fontVariationSettings: "'wght' 400" }}>
        1️⃣
      </p>
    </div>
  );
