You want FULL BILLING FLOW PROMPT (Complete System) including:

Billing structure

Commission coupon

Split bill (admin controlled)

Chat message auto split

Remove online full payment

Only ₹20 token online
...
Here is your COMPLETE MASTER PROMPT 👇 Copy this fully.

✅ FULL BILLING SYSTEM PROMPT (FINAL VERSION)
