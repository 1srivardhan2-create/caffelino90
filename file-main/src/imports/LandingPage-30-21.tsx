  ...
  return (
    <div className="bg-white h-[128px] relative rounded-[16px] shrink-0 w-[212px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[12px] h-[128px] items-center justify-center pb-[1.613px] pt-[1.6px] px-[1.6px] relative w-[212px]">
        <div className="absolute h-[37.003px] left-[88.5px] top-[21.5px] w-[35px]" data-name="oner1">
          <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid box-border inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute h-[231.03%] left-[-72.42%] max-w-none top-[-66.83%] w-[243.47%]" src={imgOner1} />
          </div>
          <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[37.003px] w-[35px]" />
        </div>
        <p className="absolute font-['Arial:Regular',_sans-serif] h-[38px] leading-[48px] left-[68.5px] not-italic text-[48px] text-black top-[61.5px] w-[76px]">GO</p>
      </div>
    </div>
  );
}
...
export default function LandingPage() {
  return (
    <div className="relative shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] size-full" data-name="LandingPage" style={{ backgroundImage: "linear-gradient(147.955deg, rgb(139, 89, 67) 2%, rgb(217, 191, 157) 52.404%, rgb(139, 89, 67) 100%), linear-gradient(90deg, rgb(248, 250, 252) 0%, rgb(248, 250, 252) 100%)" }}>
