...
function Card() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[32px] h-[141.6px] items-start left-0 pb-[0.8px] pl-[24.8px] pr-[0.8px] pt-[24.8px] rounded-[14px] top-0" data-name="Card" style={{ backgroundImage: "linear-gradient(136.13deg, rgba(139, 89, 67, 0.7) 13.833%, rgba(217, 191, 157, 0.7) 50.997%, rgba(139, 89, 67, 0.7) 89.709%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%), linear-gradient(90deg, rgba(139, 89, 67, 0) 0%, rgba(139, 89, 67, 0) 100%)" }}>
      ...
      <HomePage />
      <div className="absolute left-[calc(50%-0.3px)] size-[60px] top-[34px] translate-x-[-50%]" data-name="coffee1 1">
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid box-border inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[204.2%] left-[-56%] max-w-none top-[-53.13%] w-[203.93%]" src={imgCoffee11} />
        </div>
        <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border size-[60px]" />
      </div>
    </div>
  );
}
...
function HomePage1() {
  return (
    <div className="absolute h-[20px] left-[9.8px] top-[95px] w-[123.6px]" data-name="HomePage">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[123.6px]">
        <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[62.21px] not-italic text-[14px] text-center text-neutral-950 text-nowrap top-[-1.2px] translate-x-[-50%] whitespace-pre">Music</p>
      </div>
    </div>
  );
}
...
function Card1() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[32px] h-[141.6px] items-start left-[199.2px] pb-[0.8px] pl-[24.8px] pr-[0.8px] pt-[24.8px] rounded-[14px] top-0" data-name="Card" style={{ backgroundImage: "linear-gradient(136.13deg, rgba(139, 89, 67, 0.7) 13.833%, rgba(217, 191, 157, 0.7) 50.997%, rgba(139, 89, 67, 0.7) 89.709%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%), linear-gradient(90deg, rgba(139, 89, 67, 0) 0%, rgba(139, 89, 67, 0) 100%)" }}>
      <div aria-hidden="true" className="absolute border-[0.8px] border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <HomePage1 />
      <div className="absolute left-[41.8px] size-[60px] top-[35px]" data-name="music1">
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid box-border inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[149.28%] left-[-23.76%] max-w-none top-[-23.88%] w-[150.21%]" src={imgMusic1} />
        </div>
        <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border size-[60px]" />
      </div>
    </div>
...
function HomePage2() {
  return (
    <div className="absolute h-[20px] left-[6.4px] top-[94px] w-[123.6px]" data-name="HomePage">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[123.6px]">
        <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[61.71px] not-italic text-[14px] text-center text-neutral-950 text-nowrap top-[-1.2px] translate-x-[-50%] whitespace-pre">Dining</p>
      </div>
    </div>
  );
}
...
function Card2() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[32px] h-[141.6px] items-start left-[597.6px] pb-[0.8px] pl-[24.8px] pr-[0.8px] pt-[24.8px] rounded-[14px] top-0" data-name="Card" style={{ backgroundImage: "linear-gradient(135.107deg, rgba(139, 89, 67, 0.7) 13.833%, rgba(217, 191, 157, 0.7) 50.997%, rgba(139, 89, 67, 0.7) 89.709%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%), linear-gradient(90deg, rgba(139, 89, 67, 0) 0%, rgba(139, 89, 67, 0) 100%)" }}>
      <div aria-hidden="true" className="absolute border-[0.8px] border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <HomePage2 />
      <div className="absolute left-[38.4px] size-[60px] top-[34px]" data-name="food1 1">
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid box-border inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute left-[-36.67%] max-w-none size-[171.67%] top-[-36.17%]" src={imgFood11} />
        </div>
        <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border size-[60px]" />
      </div>
    </div>
...
function HomePage3() {
  return (
    <div className="absolute h-[20px] left-[6.6px] top-[94px] w-[123.6px]" data-name="HomePage">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[123.6px]">
        <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[62.21px] not-italic text-[14px] text-center text-neutral-950 text-nowrap top-[-1.2px] translate-x-[-50%] whitespace-pre">Books</p>
      </div>
    </div>
  );
}
...
function Card3() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[32px] h-[141.6px] items-start left-[398.4px] pb-[0.8px] pl-[24.8px] pr-[0.8px] pt-[24.8px] rounded-[14px] top-0" data-name="Card" style={{ backgroundImage: "linear-gradient(134.898deg, rgba(139, 89, 67, 0.7) 13.833%, rgba(217, 191, 157, 0.7) 50.997%, rgba(139, 89, 67, 0.7) 89.709%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%), linear-gradient(90deg, rgba(139, 89, 67, 0) 0%, rgba(139, 89, 67, 0) 100%)" }}>
      <div aria-hidden="true" className="absolute border-[0.8px] border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <HomePage3 />
      <div className="absolute left-[38.6px] size-[60px] top-[34px]" data-name="book1 1">
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid box-border inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[225.48%] left-[-62.56%] max-w-none top-[-49.08%] w-[226.3%]" src={imgBook11} />
        </div>
        <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border size-[60px]" />
      </div>
    </div>
...
function HomePage4() {
  return (
    <div className="absolute h-[20px] left-[13px] top-[95px] w-[123.6px]" data-name="HomePage">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[123.6px]">
        <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[61.71px] not-italic text-[14px] text-center text-neutral-950 text-nowrap top-[-1.2px] translate-x-[-50%] whitespace-pre">Gaming</p>
      </div>
    </div>
  );
}
...
function Card4() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[32px] h-[142px] items-start left-[797px] pb-[0.8px] pl-[24.8px] pr-[0.8px] pt-[24.8px] rounded-[14px] top-0 w-[149px]" data-name="Card" style={{ backgroundImage: "linear-gradient(137.304deg, rgba(139, 89, 67, 0.7) 13.833%, rgba(217, 191, 157, 0.7) 50.997%, rgba(139, 89, 67, 0.7) 89.709%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%), linear-gradient(90deg, rgba(139, 89, 67, 0) 0%, rgba(139, 89, 67, 0) 100%)" }}>
      <div aria-hidden="true" className="absolute border-[0.8px] border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <HomePage4 />
      <div className="absolute left-[45px] size-[60px] top-[32px]" data-name="game1 1">
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid box-border inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute left-[-42.72%] max-w-none size-[186.67%] top-[-44.5%]" src={imgGame11} />
        </div>
        <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border size-[60px]" />
      </div>
    </div>
...
function Container26() {
  return (
    <div className="absolute bg-indigo-100 content-stretch flex items-center justify-center left-[92.9px] rounded-[2.68435e+07px] size-[64px] top-0" data-name="Container">
      <p className="font-['Arial:Regular',_sans-serif] leading-[32px] not-italic relative shrink-0 text-[24px] text-black text-center text-nowrap whitespace-pre">1</p>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="absolute h-[20px] left-0 top-[112px] w-[255.8px]" data-name="Paragraph">
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[128.25px] not-italic text-[14px] text-center text-neutral-950 text-nowrap top-[-1.2px] translate-x-[-50%] whitespace-pre">Create your profile in seconds</p>
    </div>
  );
}
...
function Container28() {
  return (
    <div className="absolute bg-indigo-100 content-stretch flex items-center justify-center left-[95.9px] rounded-[2.68435e+07px] size-[64px] top-0" data-name="Container">
      <p className="font-['Arial:Regular',_sans-serif] leading-[32px] not-italic relative shrink-0 text-[24px] text-black text-center text-nowrap whitespace-pre">2</p>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="absolute h-[20px] left-0 top-[112px] w-[255.8px]" data-name="Paragraph">
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[127.41px] not-italic text-[#030213] text-[14px] text-center text-nowrap top-[-1.2px] translate-x-[-50%] whitespace-pre">Find people with similar interests</p>
    </div>
  );
}
...
function Container30() {
  return (
    <div className="absolute bg-indigo-100 content-stretch flex items-center justify-center left-[95.9px] rounded-[2.68435e+07px] size-[64px] top-0" data-name="Container">
      <p className="font-['Arial:Regular',_sans-serif] leading-[32px] not-italic relative shrink-0 text-[24px] text-black text-center text-nowrap whitespace-pre">3</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="absolute h-[20px] left-0 top-[112px] w-[255.8px]" data-name="Paragraph">
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[128.07px] not-italic text-[#030213] text-[14px] text-center text-nowrap top-[-1.2px] translate-x-[-50%] whitespace-pre">Decide time and split the bill</p>
    </div>
  );
}
...
function Container32() {
  return (
    <div className="absolute bg-indigo-100 content-stretch flex items-center justify-center left-[95.9px] rounded-[2.68435e+07px] size-[64px] top-0" data-name="Container">
      <p className="font-['Arial:Regular',_sans-serif] leading-[32px] not-italic relative shrink-0 text-[24px] text-black text-center text-nowrap whitespace-pre">4</p>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="absolute h-[20px] left-0 top-[112px] w-[255.8px]" data-name="Paragraph">
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[127.55px] not-italic text-[#030213] text-[14px] text-center text-nowrap top-[-1.2px] translate-x-[-50%] whitespace-pre">Enjoy your social dining experience</p>
    </div>
  );
}
...
function Section4() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[48px] h-[344px] items-start left-0 pb-0 pt-[64px] px-[16px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[1316.96px] w-[1151.2px]" data-name="Section">
      <Heading7 />
      <Container34 />
    </div>
  );
...
function Container49() {
  return (
    <div className="h-[52.8px] relative shrink-0 w-full" data-name="Container">
      ...
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[559.33px] not-italic text-[#90a1b9] text-[14px] text-center text-nowrap top-[31.6px] translate-x-[-50%] whitespace-pre">© 2025 Caffélino. All rights reserved.</p>
    </div>
  );
}
