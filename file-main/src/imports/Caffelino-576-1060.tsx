...
export default function Caffelino() {
  return (
    <div className="bg-[#fffbf5] relative size-full" data-name="caffelino">
      <div className="absolute bg-[#f8fafc] content-stretch flex flex-col h-[1674.4px] items-start left-0 pb-0 pt-[56px] px-0 top-[-731.2px] w-[1159.2px]" data-name="AppContent">
        <div className="bg-[#fffbf5] h-[1618.4px] overflow-clip relative shrink-0 w-full" data-name="HomePage">
                ...
                <div className="absolute border-[#45556c] border-[0.8px] border-solid left-0 rounded-[2.68435e+07px] size-[36px] top-[76px]" data-name="Link">
                  <div className="absolute left-[9.2px] size-[16px] top-[9.2px]" data-name="Icon">
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
                      <g clipPath="url(#clip0_576_1064)" id="Icon">
                        ...
                        <path d={svgPaths.p22514500} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          ...
          <div className="absolute content-stretch flex flex-col h-[1292.8px] items-start left-0 top-[0.8px] w-[1159.2px]" data-name="Container">
            <div className="h-[420px] relative shrink-0 w-full" data-name="Container" style={{ backgroundImage: "linear-gradient(46.3208deg, rgb(139, 89, 67) 10.285%, rgb(217, 191, 157) 50.797%, rgb(139, 89, 67) 91.372%)" }}>
                        ...
                        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[16px] items-center justify-center relative size-full">
                          ...
                          <div className="bg-[#0a0a0a] h-[56px] relative rounded-[16px] shrink-0 w-[205.2px]" data-name="Button">
                            ...
                            <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
                              ...
                              <p className="absolute font-['Arial:Bold',sans-serif] leading-[24px] left-[116.6px] not-italic text-[16px] text-center text-nowrap text-white top-[13.8px] translate-x-[-50%]">Join Meetup</p>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div className="h-[364px] relative shrink-0 w-full" data-name="Container">
              ...
              <div className="absolute h-[180px] left-[24px] top-[120px] w-[1111.2px]" data-name="Container">
                <ContainerBackgroundImage2 additionalClassNames="left-[4px]">
                  <ContainerBackgroundImage additionalClassNames="bg-[#8b5943] size-[64px]">
                    <IconBackgroundImage>
                      ...
                      <path d={svgPaths.p19b7d540} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
                      <path d={svgPaths.p31149280} id="Vector_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
            ...
            <div className="h-[444px] relative shrink-0 w-full" data-name="Container" style={{ backgroundImage: "linear-gradient(159.042deg, rgb(139, 89, 67) 0%, rgb(217, 191, 157) 49.038%, rgba(139, 89, 67, 0.98) 95.673%)" }}>
              ...
              <div className="absolute h-[244px] left-[24px] top-[136px] w-[1111.2px]" data-name="Container">
                <div className="absolute bg-white content-stretch flex flex-col h-[120px] items-start left-[4px] pb-0 pt-[24px] px-[24px] rounded-[16px] shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)] top-0 w-[539.6px]" data-name="Container">
                  <div className="content-stretch flex gap-[16px] h-[52px] items-start relative shrink-0 w-full" data-name="Container">
                    <ContainerBackgroundImage additionalClassNames="bg-[rgba(139,89,67,0.2)] size-[48px]">
